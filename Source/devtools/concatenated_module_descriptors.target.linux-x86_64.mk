...
$(gyp_shared_intermediate_dir)/blink/devtools/common/modules.js: $(LOCAL_PATH)/third_party/WebKit/Source/devtools/scripts/concatenate_module_descriptors.py $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/common/modules.js $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/audits/module.json $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/console/module.json $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/devices/module.json $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/elements/module.json $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/extensions/module.json $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/layers/module.json $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/main/module.json $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/network/module.json $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/profiler/module.json $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/resources/module.json $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/settings/module.json $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/source_frame/module.json $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/sources/module.json $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/timeline/module.json $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/documentation/module.json $(GYP_TARGET_DEPENDENCIES)
	...
	$(hide)cd $(gyp_local_path)/third_party/WebKit/Source/devtools; mkdir -p $(gyp_shared_intermediate_dir)/blink/devtools/common; python scripts/concatenate_module_descriptors.py front_end/common/modules.js "$(gyp_shared_intermediate_dir)/blink/devtools/common/modules.js" front_end/audits/module.json front_end/console/module.json front_end/devices/module.json front_end/elements/module.json front_end/extensions/module.json front_end/layers/module.json front_end/main/module.json front_end/network/module.json front_end/profiler/module.json front_end/resources/module.json front_end/settings/module.json front_end/source_frame/module.json front_end/sources/module.json front_end/timeline/module.json front_end/documentation/module.json



GYP_GENERATED_OUTPUTS := \
	$(gyp_shared_intermediate_dir)/blink/devtools/common/modules.js
