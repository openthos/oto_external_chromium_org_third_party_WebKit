...
$(gyp_shared_intermediate_dir)/resources/inspector/network/_module.js: gyp_local_path := $(LOCAL_PATH)
$(gyp_shared_intermediate_dir)/resources/inspector/network/_module.js: gyp_var_prefix := $(GYP_VAR_PREFIX)
$(gyp_shared_intermediate_dir)/resources/inspector/network/_module.js: gyp_intermediate_dir := $(abspath $(gyp_intermediate_dir))
$(gyp_shared_intermediate_dir)/resources/inspector/network/_module.js: gyp_shared_intermediate_dir := $(abspath $(gyp_shared_intermediate_dir))
$(gyp_shared_intermediate_dir)/resources/inspector/network/_module.js: export PATH := $(subst $(ANDROID_BUILD_PATHS),,$(PATH))
$(gyp_shared_intermediate_dir)/resources/inspector/network/_module.js: $(LOCAL_PATH)/third_party/WebKit/Source/devtools/scripts/inline_js_imports.py $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/network/_module.js $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/network/HAREntry.js $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/network/NetworkItemView.js $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/network/NetworkPanel.js $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/network/RequestCookiesView.js $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/network/RequestHeadersView.js $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/network/RequestHTMLView.js $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/network/RequestJSONView.js $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/network/RequestPreviewView.js $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/network/RequestResponseView.js $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/network/RequestTimingView.js $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/network/RequestView.js $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/network/ResourceWebSocketFrameView.js $(GYP_TARGET_DEPENDENCIES)
	@echo "Gyp action: third_party_WebKit_Source_devtools_devtools_gyp_build_network_module_target_build_network_module ($@)"
	$(hide)cd $(gyp_local_path)/third_party/WebKit/Source/devtools; mkdir -p $(gyp_shared_intermediate_dir)/resources/inspector/network; python scripts/inline_js_imports.py front_end/network/_module.js "$(gyp_shared_intermediate_dir)/resources/inspector/network/_module.js"



GYP_GENERATED_OUTPUTS := \
	$(gyp_shared_intermediate_dir)/resources/inspector/network/_module.js
